<template>
  ...
  <section class="ability-view-root">
    <template v-for="abilityKey in AbilityStructure" :key="abilityKey.type">
      <div
        class="ability-generic-term"
        :data-ability-type="abilityKey.type"
        v-t="`glossary.ability.${abilityKey.type}.generic-term`"
      />
      <div
      ...
      >
        <div
          class="ability-name"
          v-t="`glossary.ability.${abilityKey.type}.${key}`"
        />
...
import { getAbilityGradeIcon } from "/@/util/resources/image";
