<template>
  ...
  <article class="data-editor-root">
    ...
    <nav class="navigation">
      <div class="transition-button" @click="transitionPrevPage()">
        <prev-icon />
      </div>
      ...
      <div class="transition-button" @click="transitionNextPage()">
        <next-icon />
      </div>
    </nav>
...
import NextIcon from "/icon/caret-forward-outline.svg?component";
import PrevIcon from "/icon/caret-back-outline.svg?component";
import CharacterEditor from "/@/components/hall-of-fame/content/editor/CharacterEditor.vue";
import StatusEditor from "/@/components/hall-of-fame/content/editor/StatusEditor.vue";
import AbilityEditor from "/@/components/hall-of-fame/content/editor/AbilityEditor.vue";
import SkillEditor from "/@/components/hall-of-fame/content/editor/SkillEditor.vue";
import FactorEditor from "/@/components/hall-of-fame/content/editor/FactorEditor.vue";
import HistoryEditor from "/@/components/hall-of-fame/content/editor/HistoryEditor.vue";
...
.data-editor-root {
  ...
  > .navigation {
    ...
    > .transition-button {
      @apply rounded-md w-[2rem] cursor-pointer;
    }
    > .pagination {
